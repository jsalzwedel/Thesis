...
For this analysis, we choose to ignore contributions with an effect smaller than 2\%.
...
%In this section, we estimate the relevant $\lambda$ parameters involved in fitting these systems.  
...
%In other words, if the hyperon yields and reconstruction efficiencies of the true Pb-Pb data are reminiscent of the yields above, then this analysis is measuring the $\Lambda\Sigma$ correlation more than the $\Lambda\Lambda$ correlation.  
