...
The primary effect seen in $\Lambda\bar{\Lambda}$ correlations should be final state interactions (FSI) of the strong nuclear force.  
The baryon-antibaryon annihilation channel is expected to suppress the low relative momentum region of the correlation functions.
Suppressions of this sort have also been seen in $p \bar{p}$ interactions \cite{Gos:2007cj,Adamczyk:2015hza}, though FSI effects in charged particle studies are somewhat obfuscated by Coulomb effects.  
