...
It is suspected that the QGP exists for only a few moments after the collision of these ions ($\sim$ fm/$c$ = $10^{-15} \mathrm{m}/c \sim 10^{-23}$ seconds).
...
The field seeks to answer questions such as "When does hadronization occur?", "What equations of state describe the evolution of the interaction region?", "What interactions are occuring between particles during during this evolution?", and "What is the size and shape of the source at kinetic freezeout?".
