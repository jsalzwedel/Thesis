...
The neutral $\Lambda$ particle is found by looking for the pion and proton that it decays into (more on this in Section \ref{sec:ParticleSelection}.
...
PID information from the TOF is also used for particles with $p > 0.8$ GeV/$c$, as the TPC cannot distinguish between pions, kaons, and protons above that threshold.
