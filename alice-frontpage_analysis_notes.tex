...
\usepackage{float} % enables 'H' option for floats ("Definitely place Here")
%\usepackage{epsfig}
%\usepackage{epstopdf}
%\usepackage{graphicx}
% number the lines
...
\addto\captionsenglish {
	...
	\renewcommand{\contentsname}{\hfill\typesetLevelTwo Table of Contents\hfill} % Added to center Contents header text, goddammit tocloft
}
% Center figures
\makeatletter
